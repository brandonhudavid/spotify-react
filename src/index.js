    ...
    if (!this.state.authenticated) {
      return (
        <div className="App">
          ...
          <a
            href={`https://accounts.spotify.com/authorize/?client_id=390641f619b14b1581aaadd96df6bbb8&response_type=token&redirect_uri=http://vibrant-lamport-7c4035.netlify.com/&scope=user-read-playback-state user-modify-playback-state user-top-read user-read-private`}
          >
